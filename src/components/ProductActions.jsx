...
// 1. Import trực tiếp các file ảnh vào đây
...
// 2. Truyền biến ảnh (không để trong dấu ngoặc kép) vào thuộc tính img
const COLORS = [
  ...
  return (
    <div style={{ background: "var(--bg)", padding: "60px 0" }}>
      <div className="container" style={{ maxWidth: "1200px" }}>
        {/* Tiêu đề chính áp dụng hiệu ứng phóng to nhẹ khi cuộn tới */}
        <h2
        ...
        <div className="row g-4 justify-content-center row-cols-1 row-cols-md-2 row-cols-lg-3">
          {/* CỘT TRÁI: HÌNH ẢNH SẢN PHẨM (Trượt lên đầu tiên) */}
          <div
            className="d-flex"
            data-aos="fade-up"
            data-aos-delay="0"
            ...
            <div className="p-4 w-100 cream-box shadow-sm d-flex flex-column justify-content-between">
              <div>
                <h3
                  ...
                  style={{ color: "#5a5245", fontSize: "1.5rem" }}
                >
                  Sản phẩm
                </h3>
          ...
          {/* CỘT GIỮA: CONFIG CẤU HÌNH (Trượt lên trễ 150ms) */}
          <div
            className="d-flex"
            data-aos="fade-up"
            data-aos-delay="150"
          ...
          >
            <div className="p-4 w-100 cream-box shadow-sm d-flex flex-column justify-content-between">
              <div>
                ...
                <div className="mb-4">
                  <span
                    className="small fw-bold d-block mb-2 text-uppercase"
                    style={{ color: "#8f734b" }}
                  >
                  ...
                  <div className="d-flex flex-wrap gap-2">
                    {STORAGE.map((size) => (
                      <button
                        ...
                        style={{
                          backgroundColor:
                            selectedStorage === size ? "#8f734b" : "#e6dfce",
                          fontSize: "0.9rem",
                        }}
                ...
                <div className="mb-3">
                  <div className="d-flex align-items-center gap-2">
                    ...
                    >
                      Tổng:{" "}
                      <strong>${(1199 * quantity).toLocaleString()}</strong>
                    </span>
                  </div>
                </div>
              </div>
              ...
              <div className="d-flex flex-column gap-2 mt-3">
                <div className="d-flex gap-2">
                  <button
                    className="btn text-white py-2 rounded-3 btn-hover cta-shimmer flex-grow-1"
                    style={{
                      background: "#8f734b",
                      fontWeight: "600",
                      fontSize: "0.95rem",
                  ...
                  <button
                    className="btn border-0 rounded-3 btn-hover d-flex align-items-center justify-content-center"
                    style={{
                      width: "50px",
                      background: isFavorite ? "#fce8e8" : "#e6dfce",
                      color: isFavorite ? "#dc3545" : "#8f734b",
                    }}
                    onClick={handleToggleFavorite}
                  >
                    <i
                      className={`bi ${isFavorite ? "bi-heart-fill" : "bi-heart"} fs-5`}
                    ></i>
                  </button>
                </div>

                <button
                  className="btn btn-dark py-2 rounded-3 btn-hover shadow-lg"
                  style={{
                    background: "linear-gradient(45deg, #2d2a2e, #5a5245)",
                    fontWeight: "700",
                    fontSize: "0.95rem",
                  }}
          ...
          {/* CỘT PHẢI: TRẠNG THÁI GIỎ HÀNG (Trượt lên trễ 300ms) */}
          <div
            className="d-flex"
            data-aos="fade-up"
            data-aos-delay="300"
              ...
              <div className="d-flex flex-column h-100 justify-content-between">
                <div>
                  ...
                  <h5
                    ...
                    style={{ color: "#8f734b", fontSize: "0.95rem" }}
                  >
                ...
                <div className="cart-container-wrapper">
                  <div className="cart-inner-scroll">
                    {cartItems.map((item) => (
                      <div
                        key={item.id}
                        className="pop-animation p-3 mb-2 bg-white rounded-3 border-start border-4 shadow-sm"
                        style={{ borderLeftColor: "#8f734b" }}
                      >
                        <div className="d-flex justify-content-between small">
                          <span className="fw-bold">{item.name}</span>
                          <span style={{ color: "#8f734b" }}>
                        ...
                        >
                          {item.color} • {item.storage} • x{item.qty}
                        </small>
                      </div>
                    ))}
                    {cartItems.length === 0 && (
                      <div className="text-center w-100 text-muted my-auto py-3">
                        <i
                          className="bi bi-basket3 fs-4 d-block mb-1"
                          style={{ color: "#a6a090" }}
                        ></i>
                        <small
                          className="italic"
              ...
              >
                ...
                <div className="d-flex flex-wrap gap-1">
                  {favoriteList.map((fav) => (
                    <span
                      key={fav.id}
                      className="badge p-2 px-3 rounded-pill pop-animation"
                      style={{
                        background: "#e6dfce",
                        color: "#5a5245",
                        fontSize: "0.8rem",
      ...
      {/* HỆ THỐNG CSS GỐC HOẠT ĐỘNG HOÀN HẢO VỚI AOS */}
      <style>{`
        .dynamic-neon-title {
          font-weight: 900;
          padding-bottom: 10px;
        ...
        .cream-box { 
          ...
          border-radius: 24px;
          /* Thiết lập transition mượt mà bao gồm cả hiệu ứng của AOS */
          transition: transform 0.5s cubic-bezier(0.16, 1, 0.3, 1), border-color 0.3s, box-shadow 0.3s !important; 
        }
        .cream-box:hover { 
          transform: translateY(-8px) !important; 
          box-shadow: 0 20px 40px rgba(143, 115, 75, 0.12); 
          border-color: #8f734b; 
        }
        ...
        .nav-arrow-btn:hover {
          background: #8f734b;
          color: #fff;
          box-shadow: 0 4px 10px rgba(143, 115, 75, 0.3);
        }
